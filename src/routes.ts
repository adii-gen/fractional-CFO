...
export const publicApis: string[] = ["/api/posts", "/api/company" ,"/posts", "/api/get", "/api/productCategory","/api/serviceCategory","/api/service" , "/api/deal-types","/api/uploadthing","/api/chatbot/inquiries","/api/bookings", "/api/expertise", "/api/faq"];
